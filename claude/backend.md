...
| `projects` | Public read API for the dynamic project system: list + detail by slug, in the requested language (`?lang=`, falling back to English), plus admin-only create/update/delete and per-language translation upsert/delete. |
